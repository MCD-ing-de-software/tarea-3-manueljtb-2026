...
def make_sample_df() -> pd.DataFrame:
    ...
    return pd.DataFrame(
        {
            "name": [" Alice ", "Bob", None, " Carol  ", "Dave", "Eve"],
            "age": [25, None, 35, 120, 20, 30],  # 120 is a likely outlier
...
class TestDataCleaner(unittest.TestCase):
    ...
    def main():
       test2= TestDataCleaner()
       test2.test_drop_invalid_rows_removes_rows_with_missing_values()
